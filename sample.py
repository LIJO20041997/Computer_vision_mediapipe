...
constant_height_threshold = 3  # Number of seconds the height must remain constant
previous_height = 0  # Initialize previous_height
l= []
...
while True:
    ...
    # Check if the height remains constant
